        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className='space-y-4 max-w-[300px]'>
            ...
            <div className='flex items-center'>
              ...
              className='p-3 rounded-s-xl bg-white py-4 w-full focus:ring-0 focus:outline-none placeholder:text-dark2 border-2 rounded-[5px] rounded-r-none border-gray-500'
              />
